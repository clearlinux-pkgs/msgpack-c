...
# autospec version: v15
# autospec commit: 43d564b
#
Name     : msgpack-c
Version  : 6.1.1
Release  : 7
URL      : https://github.com/msgpack/msgpack-c/releases/download/cpp-6.1.1/msgpack-cxx-6.1.1.tar.gz
Source0  : https://github.com/msgpack/msgpack-c/releases/download/cpp-6.1.1/msgpack-cxx-6.1.1.tar.gz
...
%prep
%setup -q -n msgpack-cxx-6.1.1
cd %{_builddir}/msgpack-cxx-6.1.1
pushd ..
cp -a msgpack-cxx-6.1.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720579496
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/msgpack-cxx-%{version}/LICENSE_1_0.txt %{buildroot}/usr/share/package-licenses/msgpack-c/3cba29011be2b9d59f6204d6fa0a386b1b2dbd90 || :
export GOAMD64=v2
pushd ../buildavx2/
GOAMD64=v3
pushd clr-build-avx2
...
/usr/include/msgpack/adaptor/cpp17/variant.hpp
...
/usr/include/msgpack/v1/adaptor/cpp17/variant.hpp
...
/usr/lib64/cmake/msgpack-cxx/msgpack-cxx-config-version.cmake
/usr/lib64/cmake/msgpack-cxx/msgpack-cxx-config.cmake
/usr/lib64/cmake/msgpack-cxx/msgpack-cxx-targets.cmake
