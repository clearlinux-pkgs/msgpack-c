...
Version  : 3.1.1
Release  : 1
URL      : https://github.com/msgpack/msgpack-c/archive/cpp-3.1.1.tar.gz
Source0  : https://github.com/msgpack/msgpack-c/archive/cpp-3.1.1.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1554312229
mkdir -p clr-build
pushd clr-build
