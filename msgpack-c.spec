...
Source0  : https://github.com/msgpack/msgpack-c/releases/download/cpp-4.1.3/msgpack-cxx-4.1.3.tar.gz
...
%prep
%setup -q -n msgpack-cxx-4.1.3
cd %{_builddir}/msgpack-cxx-4.1.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672187835
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/cmake/msgpackc-cxx/msgpack-config-version.cmake
/usr/lib64/cmake/msgpackc-cxx/msgpack-config.cmake
/usr/lib64/cmake/msgpackc-cxx/msgpackc-cxx-targets.cmake
