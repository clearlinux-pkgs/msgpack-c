...
Source0  : https://github.com/msgpack/msgpack-c/releases/download/cpp-3.3.0/msgpack-3.3.0.tar.gz
...
%prep
%setup -q -n msgpack-3.3.0
cd %{_builddir}/msgpack-3.3.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1608318108
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/msgpack-3.3.0/LICENSE_1_0.txt %{buildroot}/usr/share/package-licenses/msgpack-c/3cba29011be2b9d59f6204d6fa0a386b1b2dbd90
pushd clr-build
%make_install
popd
